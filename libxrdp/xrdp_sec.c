...
static tui8 g_pad_54[40] = { 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54,
		54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54,
		54, 54, 54, 54, 54, 54, 54, 54, 54 };

/* some compilers need unsigned char to avoid warnings */
static tui8 g_pad_92[48] = { 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92,
		92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92,
		92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92, 92 };

/* some compilers need unsigned char to avoid warnings */
static tui8 g_lic1[322] = { 0x80, 0x00, 0x3e, 0x01, 0x01, 0x02, 0x3e, 0x01,
		0x7b, 0x3c, 0x31, 0xa6, 0xae, 0xe8, 0x74, 0xf6, 0xb4, 0xa5, 0x03, 0x90,
		0xe7, 0xc2, 0xc7, 0x39, 0xba, 0x53, 0x1c, 0x30, 0x54, 0x6e, 0x90, 0x05,
		0xd0, 0x05, 0xce, 0x44, 0x18, 0x91, 0x83, 0x81, 0x00, 0x00, 0x04, 0x00,
		0x2c, 0x00, 0x00, 0x00, 0x4d, 0x00, 0x69, 0x00, 0x63, 0x00, 0x72, 0x00,
		...
		 };

/* some compilers need unsigned char to avoid warnings */
static tui8 g_lic2[20] = { 0x80, 0x00, 0x10, 0x00, 0xff, 0x02, 0x10, 0x00, 0x07,
		0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x28, 0x14, 0x00, 0x00 };

/* mce */
/* some compilers need unsigned char to avoid warnings */
static tui8 g_lic3[20] = { 0x80, 0x02, 0x10, 0x00, 0xff, 0x03, 0x10, 0x00, 0x07,
		0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0xf3, 0x99, 0x00, 0x00 };

static const tui8 g_fips_reverse_table[256] = { 0x00, 0x80, 0x40, 0xc0, 0x20,
...
static const tui8 g_fips_oddparity_table[256] = {  };

static const tui8 g_fips_ivec[8] = { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD,
		0xEF };
...
xrdp_load_keyboard_layout(struct xrdp_client_info *client_info) {
	...
	if (fd > 0) {
		...
		for (index = 0; index < names->count; index++) {
			...
			if (g_strncasecmp("default", q, 8) != 0) {
				...
				for (i = 0; i < items->count; i++) {
					...
					LLOGLN(10,
							("xrdp_load_keyboard_layout: item %s value %s", item, value));
					if (g_strcasecmp(item, "keyboard_type") == 0) {
						 ...
						 */
						LLOGLN(10,
								("xrdp_load_keyboard_layout: skipping " "configuration item - %s, continuing to next " "section", item));
						break;
					}
				}
		...
		LLOGLN(0,
				("xrdp_load_keyboard_layout: model [%s] variant [%s] " "layout [%s]", client_info->model, client_info->variant, client_info->layout));
		g_file_close(fd);
	} else {
		LLOGLN(0,
				("xrdp_load_keyboard_layout: error opening %d", keyboard_cfg_file));
	}
}
...
xrdp_sec_process_logon_info(struct xrdp_sec *self, struct stream *s) {
	...
	{
		/* must be or error */
		log_error("xrdp_sec_process_logon_info: flags wrong, major error");
		LLOGLN(0,
				("xrdp_sec_process_logon_info: flags wrong, likely decrypt " "not working"));
		return 1;
	}
	...
	if (unicode_in(s, len_domain, self->rdp_layer->client_info.domain, 255)
			!= 0) {
		return 1;
	}
	DEBUG("domain %s", self->rdp_layer->client_info.domain);
	if (unicode_in(s, len_user, self->rdp_layer->client_info.username, 255)
			!= 0) {
		return 1;
	}
	...
	if (flags & RDP_LOGON_AUTO) {
		if (unicode_in(s, len_password, self->rdp_layer->client_info.password,
				255) != 0) {
			return 1;
		}
		DEBUG("flag RDP_LOGON_AUTO found");
		...
		if (self->rdp_layer->client_info.require_credentials) {
			g_writeln(
					"xrdp_sec_process_logon_info: credentials on cmd line is mandatory");
			return 1; /* credentials on cmd line is mandatory */
		}
	}

	if (unicode_in(s, len_program, self->rdp_layer->client_info.program, 255)
			!= 0) {
		return 1;
	}
	DEBUG("program %s", self->rdp_layer->client_info.program);
	if (unicode_in(s, len_directory, self->rdp_layer->client_info.directory,
			255) != 0) {
		return 1;
	}
...
xrdp_sec_rsa_op(struct xrdp_sec *self, char *out, char *in, int in_bytes,
		char *mod, char *exp) {
	ssl_mod_exp(out, self->rsa_key_bytes, in, in_bytes, mod,
			self->rsa_key_bytes, exp, self->rsa_key_bytes);
}
...
xrdp_sec_fips_establish_keys(struct xrdp_sec *self) {
	...
	self->encrypt_fips_info = ssl_des3_encrypt_info_create(
			self->fips_encrypt_key, fips_ivec);
	self->decrypt_fips_info = ssl_des3_decrypt_info_create(
			self->fips_decrypt_key, fips_ivec);
...
xrdp_sec_establish_keys(struct xrdp_sec *self) {
	...
	xrdp_sec_hash_48(temp_hash, input, self->client_random, self->server_random,
			65);
...
xrdp_sec_recv_fastpath(struct xrdp_sec *self, struct stream *s) {
	...
	if (self->fastpath_layer->secFlags & FASTPATH_INPUT_ENCRYPTED) {
		if (self->crypt_level == CRYPT_LEVEL_FIPS) {
			...
			in_uint8(s, pad);
			LLOGLN(10,
					("xrdp_sec_recv_fastpath: len %d ver %d pad %d", len, ver, pad));
			in_uint8s(s, 8); /* dataSignature (8 bytes), skip for now */
			LLOGLN(10,
					("xrdp_sec_recv_fastpath: data len %d", (int)(s->end - s->p)));
	...
	if (flags & SEC_LOGON_INFO)
	{
		...
		if (self->rdp_layer->client_info.is_mce) {
			if (xrdp_sec_send_media_lic_response(self) != 0) {
				log_error(" out xrdp_sec_recv error");
				return 1;
			}
...
static void buf_out_uint32(char *buffer, int value) {
	buffer[0] = (value) & 0xff;
...
static void APP_CC
xrdp_sec_fips_sign(struct xrdp_sec *self, char *out, int out_len, char *data,
		int data_len) {
	char buf[20];
	char lenhdr[4];
...
/* Generate a MAC hash (5.2.3.1), using a combination of SHA1 and MD5 */
static void APP_CC
xrdp_sec_sign(struct xrdp_sec *self, char *out, int out_len, char *data,
		int data_len) {
	char shasig[20];
	char md5sig[16];
	char lenhdr[4];
...
xrdp_sec_process_mcs_data_CS_CORE(struct xrdp_sec* self, struct stream* s) {
	...
	switch (version) {
	case 0x00080001:
		g_writeln("RDP 4.0 client");
		break;
	case 0x00080004:
		g_writeln("RDP 5.0 - 8.1 client");
		break;
	case 0x00080005:
		g_writeln("RDP 10.0 client");
		break;
	default:
		g_writeln("RDP unknown client version : 0x%4.4x", version);
	}

	in_uint16_le(s, self->rdp_layer->client_info.width);
	in_uint16_le(s, self->rdp_layer->client_info.height);
	g_writeln("RDP client requested resolution : %d x %d",
	...
	case RNS_UD_COLOR_4BPP:
		...
		g_writeln("RDP client requested 4 bits-per-pixel color depth");
		break;
	case RNS_UD_COLOR_8BPP:
		self->rdp_layer->client_info.bpp = 8;
		g_writeln("RDP client requested 8 bits-per-pixel color depth");
		break;
	default:
		g_writeln("RDP client requested an unsupported color depth : 0x%4.4x",
				colorDepth);
	}
	...
	case RNS_UD_COLOR_16BPP_555:
		...
		g_writeln("RDP client requested 15 bits-per-pixel color depth");
		break;
	case RNS_UD_COLOR_16BPP_565:
		self->rdp_layer->client_info.bpp = 16;
		g_writeln("RDP client requested 16 bits-per-pixel color depth");
		break;
	case RNS_UD_COLOR_24BPP:
		self->rdp_layer->client_info.bpp = 24;
		g_writeln("RDP client requested 24 bits-per-pixel color depth");
		break;
	default:
		g_writeln("RDP client requested an unsupported color depth : 0x%4.4x",
				postBeta2ColorDepth);
	...
	if (supportedColorDepths & HIGH_COLOR_4BPP)
		g_writeln("RDP client supports a 4 bits-per-pixel color depth");
	if (supportedColorDepths & HIGH_COLOR_8BPP)
		g_writeln("RDP client supports a 8 bits-per-pixel color depth");
	if (supportedColorDepths & HIGH_COLOR_15BPP)
		g_writeln("RDP client supports a 15 bits-per-pixel color depth");
	if (supportedColorDepths & HIGH_COLOR_16BPP)
		g_writeln("RDP client supports a 16 bits-per-pixel color depth");
	if (supportedColorDepths & HIGH_COLOR_24BPP)
		g_writeln("RDP client supports a 24 bits-per-pixel color depth");

	if (!s_check_rem(s, 2)) {
		return 0;
	}
	in_uint16_le(s, earlyCapabilityFlags);
	self->rdp_layer->client_info.mcs_early_capability_flags =
			earlyCapabilityFlags;
	if ((earlyCapabilityFlags & RNS_UD_CS_WANT_32BPP_SESSION)) {
		g_writeln("RDP client requested a 32 bits-per-pixel color depth");
		self->rdp_layer->client_info.bpp = 32;
	}
	if (earlyCapabilityFlags & RNS_UD_CS_SUPPORT_ERRINFO_PDU)
		g_writeln("RDP client supports the Set Error Info PDU");

	if (earlyCapabilityFlags & RNS_UD_CS_SUPPORT_STATUSINFO_PDU)
		g_writeln("RDP client supports the Server Status Info PDU");
	if (earlyCapabilityFlags & RNS_UD_CS_STRONG_ASYMMETRIC_KEYS)
		g_writeln("RDP client supports asymmetric keys larger than 512 bits");
	if (earlyCapabilityFlags & RNS_UD_CS_SUPPORT_MONITOR_LAYOUT_PDU)
		g_writeln("RDP client supports the Monitor Layout PDU");
	if (earlyCapabilityFlags & RNS_UD_CS_SUPPORT_NETCHAR_AUTODETECT)
		g_writeln("RDP client supports network characteristics detection");
	if (earlyCapabilityFlags & RNS_UD_CS_SUPPORT_DYNVC_GFX_PROTOCOL)
		g_writeln(
				"RDP client supports the Graphics Pipeline Extension Protocol");
	if (earlyCapabilityFlags & RNS_UD_CS_SUPPORT_DYNAMIC_TIME_ZONE)
		g_writeln("RDP client supports Dynamic DST");
	if (earlyCapabilityFlags & RNS_UD_CS_SUPPORT_HEARTBEAT_PDU)
		g_writeln("RDP client supports the Heartbeat PDU");
	if (!s_check_rem(s, 64)) {
		return 0;
	}
	...
	in_uint8(s, connectionType);

	self->rdp_layer->client_info.mcs_connection_type = connectionType;
	if (earlyCapabilityFlags & RNS_UD_CS_VALID_CONNECTION_TYPE) {
		switch (connectionType) {
		case CONNECTION_TYPE_MODEM:
			g_writeln("RDP client connection is modem (56 Kbps)");
			break;
		case CONNECTION_TYPE_BROADBAND_LOW:
			g_writeln(
					"RDP client connection is low-speed broadband (256 Kbps - 2 Mbps)");
			break;
		case CONNECTION_TYPE_SATELLITE:
			g_writeln(
					"RDP client connection is satellite (2 Mbps - 16 Mbps with high latency)");
			break;
		case CONNECTION_TYPE_BROADBAND_HIGH:
			g_writeln(
					"RDP client connection is high-speed broadband (2 Mbps - 10 Mbps)");
			break;
		case CONNECTION_TYPE_WAN:
			g_writeln(
					"RDP client connection is WAN (10 Mbps or higher with high latency)");
			break;
		case CONNECTION_TYPE_LAN:
			g_writeln("RDP client connection is LAN (10 Mbps or higher)");
			break;
		default:
			g_writeln("RDP client connection is to be detected by the server");
			break;
		}
		self->rdp_layer->client_info.mcs_connection_type = connectionType;
	} else {
	...
	in_uint8s(s, 2); /* desktopOrientation */

	if (!s_check_rem(s, 4)) {
		return 0;
	}
	in_uint8s(s, 4); /* desktopScaleFactor */

	if (!s_check_rem(s, 4)) {
		return 0;
	}
	in_uint8s(s, 4); /* deviceScaleFactor */
...
xrdp_sec_process_mcs_data_CS_SECURITY(struct xrdp_sec *self, struct stream* s) {
	...
	if (crypt_method == 0) {
		g_writeln("Error : RDP client do not provide encryption method");
		return 1;
	}
	if (crypt_method & CRYPT_METHOD_40BIT) {
		g_writeln("RDP client supports 40 bit encryption");
	}
	if (crypt_method & CRYPT_METHOD_56BIT) {
		g_writeln("RDP client supports 56 bit encryption");
	}
	if (crypt_method & CRYPT_METHOD_128BIT) {
		g_writeln("RDP client supports 128 bit encryption");
	}
	if (crypt_method & CRYPT_METHOD_FIPS) {
		g_writeln("RDP client supports fips encryption");
	}
	found = 0;
	if ((found == 0) && (self->crypt_method & CRYPT_METHOD_FIPS)
			&& (self->crypt_level == CRYPT_LEVEL_FIPS)) {
		if (crypt_method & CRYPT_METHOD_FIPS) {
			g_writeln("RDP client and server support fips, using fips");
			self->crypt_method = CRYPT_METHOD_FIPS;
			self->crypt_level = CRYPT_LEVEL_FIPS;
			found = 1;
		}
	}
	if ((found == 0) && (self->crypt_method & CRYPT_METHOD_128BIT)
			&& (self->crypt_level == CRYPT_LEVEL_HIGH)) {
		if (crypt_method & CRYPT_METHOD_128BIT) {
			g_writeln("RDP client and server support high crypt, using "
					"high crypt");
	...
	if ((found == 0) && (self->crypt_method & CRYPT_METHOD_40BIT)
			&& (self->crypt_level == CRYPT_LEVEL_CLIENT_COMPATIBLE)) {
		if (crypt_method & CRYPT_METHOD_40BIT) {
			g_writeln("RDP client and server support medium crypt, using "
					"medium crypt");
	...
	if ((found == 0) && (self->crypt_method & CRYPT_METHOD_40BIT)
		...
		if (crypt_method & CRYPT_METHOD_40BIT) {
			g_writeln("RDP client and server support low crypt, using "
					"low crypt");
			self->crypt_method = CRYPT_METHOD_40BIT;
			self->crypt_level = CRYPT_LEVEL_LOW;
			found = 1;
	...
	if ((found == 0) && (self->crypt_level == CRYPT_LEVEL_NONE)) {
		if (crypt_method == CRYPT_METHOD_NONE) {
			g_writeln("RDP client and server support none crypt, using "
					"none crypt");
			self->crypt_method = CRYPT_METHOD_NONE;
			self->crypt_level = CRYPT_LEVEL_NONE;
			found = 1;
	...
	if (found == 0) {
		g_writeln(
				"Error:  can not find client / server agreed encryption method");
		return 1;
	}
	return 0;
}
...
xrdp_sec_process_mcs_data_channels(struct xrdp_sec *self, struct stream *s) {
	...
	DEBUG(
			"processing channels, channel_code is %d", client_info->channel_code);
	...
	for (index = 0; index < num_channels; index++) {
		...
		channel_item = (struct mcs_channel_item *) g_malloc(
				sizeof(struct mcs_channel_item), 1);
		if (!s_check_rem(s, 12)) {
			g_free(channel_item);
			return 1;
		}
		...
		DEBUG(
				"got channel flags %8.8x name %s", channel_item->flags, channel_item->name);
	}
...
xrdp_sec_process_mcs_data_monitors(struct xrdp_sec *self, struct stream *s) {
	...
	DEBUG(
			"processing monitors data, allow_multimon is %d", client_info->multimon);
	/* this is an option set in xrdp.ini */
...
//verify monitorCount - max 16
	...
	for (index = 0; index < monitorCount; index++) {
		...
		g_writeln(
				"got a monitor: left= %d, top= %d, right= %d, bottom= %d, is_primary?= %d",
				client_info->minfo[index].left, client_info->minfo[index].top,
...
xrdp_sec_process_mcs_data(struct xrdp_sec *self) {
	...
	while (s_check_rem(s, 4)) {
		...
		if ((size < 4) || (!s_check_rem(s, size - 4))) {
			LLOGLN(0,
					("error in xrdp_sec_process_mcs_data tag %d size %d", tag, size));
			break;
		}
		...
		case SEC_TAG_CLI_MONITOR: /* CS_MONITOR        0xC005 */
			if (xrdp_sec_process_mcs_data_monitors(self, s) != 0) {
				g_writeln("Error while processing CS_MONITOR");
				return 1;
			}
			break;
		...
		default:
			g_writeln("Error while processing unsupported CS %d", tag);
			LLOGLN(0,
					("error unknown xrdp_sec_process_mcs_data " "tag 0x%4.4x size %d", tag, size));
			break;
		}
	...
	if (self->rdp_layer->client_info.max_bpp > 0) {
		if (self->rdp_layer->client_info.bpp
			...
			LLOGLN(0,
					("xrdp_rdp_parse_client_mcs_data: client asked " "for %dbpp connection but configuration is limited " "to %dbpp", self->rdp_layer->client_info.bpp, self->rdp_layer->client_info.max_bpp));
...
xrdp_sec_init_rdp_security(struct xrdp_sec *self) {
	...
	case 4: /* fips */
		...
		break;
	default:
		log_error("iIllegal crypt level %d",self->rdp_layer->client_info.crypt_level);
		break;
	}
...
xrdp_sec_incoming(struct xrdp_sec *self) {
	...
	if (iso->selectedProtocol > PROTOCOL_RDP) {
		...
		if (self->crypt_method != CRYPT_METHOD_NONE) {
			...
			if (file_by_name_read_section(key_file, "keys", items, values)
					!= 0) {
